...
class DownloadThread(threading.Thread):
    def __init__(self, id, wiki):
        ...
        self._wiki = wiki
        self._id = id
        self._file = wiki.outputPathDirectory() + wiki.delim() + wiki.outputPath() % {
        "lang": wiki.lang()} + wiki.delim() + "T" + repr(id) + ".txt"
        self._pagebreak = "\r\n"
        ...
        if self.is_list(inputPath):
            ...
            if os.path.isfile(inputPath):
                ...
                try:
                    ...
                    inputPath = [inputPath + self._delim + f for f in os.listdir(inputPath) if
                                 os.path.isfile(inputPath + self._delim + f)]
...
def main(argv=None):
    def usage():
        ...
        print(
            "	--name|-n <name>		set the subdirectory of output directory where the results will be stored; %(lang)s can be used")
